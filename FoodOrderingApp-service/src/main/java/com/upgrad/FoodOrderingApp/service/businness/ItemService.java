...
public class ItemService {
    ...
    public List<ItemEntity> getItemsByCategoryAndRestaurant(final String restaurantUUID , final String categoryUUID) {
        ...
        CategoryEntity filterCategoryEntity = categoryEntities.stream().filter(categoryEntity -> categoryEntity.getUuid().equals(categoryUUID)).collect(Collectors.toList());
