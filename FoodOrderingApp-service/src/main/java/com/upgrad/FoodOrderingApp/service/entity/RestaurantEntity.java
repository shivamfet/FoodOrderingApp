...
@NamedQueries(
        {
                ...
                @NamedQuery(name = "getRestaurantsByName" , query = "select restaurant from RestaurantEntity restaurant where lower(restaurant.restaurantName) like :restaurantName")
        }
)
